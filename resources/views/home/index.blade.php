                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="lgx-banner-info lgx-banner-info-center">
                                    ...
                                    <h2 class="title"><span id="lgx-typed-string">Bihar Startup Connect</span>
                                    </h2>
                                    <h3 class="location location-text"><i class="fa fa-map-marker"></i> Gyan
                                        Bhawan, Bihar, Patna</h3>
                            ...
                            <div class="lgx-about-content-area">
                                ...
                                <div class="lgx-about-content">
                                    <p class="text">Bihar Startup Connect 2024 is a premier event that brings
                                        together the brightest minds, innovators, and entrepreneurs from across
                                        Bihar and beyond. This dynamic platform is designed to showcase the thriving
                                        startup ecosystem in Bihar, providing a space for entrepreneurs, investors,
                                        industry experts, and policymakers to connect, collaborate, and grow
                                        together.</p>
                                    <div class="section-btn-area">
                                        <a class="lgx-btn" href="#lgx-schedule">Schedule</a>
                                        <a class="lgx-btn lgx-btn-red lgx-scroll" href="register.html">Register
                                            Now</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="lgx-heading">
                                ...
                                <h3 class="subheading">Welcome to the dedicated to building remarkable Speakers!
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="lgx-single-speaker lgx-single-speaker-circle">
                                <figure>
                                    <a class="profile-img" href="speakers.html"><img
                                            src="assets/img/speakers/prakhar kuamr singh.jpg" alt="speaker" /></a>
                                    <figcaption>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="lgx-single-speaker lgx-single-speaker-circle">
                                <figure>
                                    <a class="profile-img" href="speakers.html"><img src="assets/img/speakers/speaker2.jpg"
                                            alt="speaker" /></a>
                                    <figcaption>
                                        <div class="social-group">
                                            <a class="sp-tw" href="#"><i class="fa fa-twitter"></i></a>
                                                    ...
                                                    <div class="panel-title">
                                                        <a role="button" data-toggle="collapse" data-parent="#accordion"
                                                            ...
                                                            <div class="lgx-single-schedule">
                                                                <div class="author">
                                                                    <img src="assets/img/schedule/startup.jpg"
                                                                        alt="Speaker" />
                                                                </div>
                                                                <div class="schedule-info">
                                                                    <h4 class="time">10:30 <span>Am</span> -
                                                                        11.30 <span>Am</span></h4>
                                                                    <h3 class="title">Inauguration Ceremony</h3>
                                                                    <!-- <h4 class="author-info">By <span>Riaz Sagar</span> , Logichunt Inc.</h4> -->
                                                                    <ul>
                                                                        <li>
                                                                            10:30 <span>Am</span> - 10:35
                                                                            <span>Am</span>
                                                                            <p>Welcome Address and Opening Remarks
                                                                            </p>
                                                                        </li>
                                                                        <li>
                                                                            10:35 <span>Am</span> - 10:40
                                                                            <span>Am</span>
                                                                            <p>5 mins Documentary on Startup Bihar
                                                                            </p>
                                                                        </li>
                                                                        <li>
                                                                            10:40 <span>Am</span> - 10:45
                                                                            <span>Am</span>
                                                                            <p>Address By Director Handloom &
                                                                                Sericulture - Context of the Event
                                                                            </p>
                                                                        </li>
                                                                        <li>
                                                                            10:45 <span>Am</span> - 10:47
                                                                            <span>Am</span>
                                                                            <p>Coffee Table Book Launch</p>
                                                                        </li>
                                                                        <li>
                                                                            10:47<span>Am</span> - 10:53
                                                                            <span>Am</span>
                                                                            <p>Experience Sharing By 2 SuccessfulL
                                                                                Startups</p>
                                                                        </li>
                                                                        <li>
                                                                            10:53 <span>Am</span> - 11:00
                                                                            <span>Am</span>
                                                                            <p>MoU Exchnage (BIRAC, ISBA, TiE,
                                                                                IIM-CIP, NASSCOM, Patna Women
                                                                                Collage )</p>
                                                                        </li>
                                                                        <li>
                                                                            11:00 <span>Am</span> - 11:05
                                                                            <span>Am</span>
                                                                            <p>Launch Of Extension Centers of
                                                                                IC-IITP</p>
                                                                        </li>
                                                                        <li>
                                                                            11:05 <span>Am</span> - 11:10
                                                                            <span>Am</span>
                                                                            <p>Address By Shri. Alok Ranjan Ghosh,
                                                                                Director Industries</p>
                                                                        </li>
                                                                        <li>
                                                                            11:10<span>Am</span> - 11:15
                                                                            <span>Am</span>
                                                            ...
                                                            <div class="lgx-single-schedule">
                                                                ...
                                                                <div class="schedule-info">
                                                                    <h4 class="time">11:25 <span>Am</span> -
                                                                        11:45 <span>Am</span></h4>
                                                                    <h3 class="title">Product Launch (by 7 to 8
                                                                        Startups)</h3>
                                                                    <!-- <h4 class="author-info">By <span>Riaz Sagar</span> , Logichunt Inc.</h4> -->
                                                                </div>
                                                            </div>
                                                            <div class="lgx-single-schedule">
                                                                ...
                                                                <div class="schedule-info">
                                                                    <h4 class="time">11:45 <span>Am</span> -
                                                                        12:00 <span>Pm</span></h4>
                                                                    <h3 class="title">Tea Networking and
                                                                        walthrough of Startup Exhibition</h3>
                                                                    <!-- <h4 class="author-info">By <span>Riaz Sagar</span> , Logichunt Inc.</h4> -->
                                                                </div>
                                                            </div>
                                                            <div class="lgx-single-schedule">
                                                                ...
                                                                <div class="schedule-info">
                                                                    <h4 class="time">12:00 <span> Pm</span> -
                                                                        1:30 <span>Pm</span></h4>
                                                                    <h3 class="title">Ideathon Finals</h3>
                                                                    <!-- <h4 class="author-info">By <span>Riaz Sagar</span> , Logichunt Inc.</h4> -->
                                                                    <ul>
                                                                        <li>
                                                                            <p style="font-weight: 800">Session by
                                                                                SIDBI</p>
                                                                            <span> Session on ‘How to mobilize SIDBI
                                                                                FoF for scaling startups in Bihar?’
                                                                            </span>
                                                                            <span>Announcement of names of funded
                                                                                Startup through SIDBI FoF. </span>
                                                                        </li>
                                                                    </ul>
                                                                    <ul>
                                                                        <li>
                                                                            <p style="font-weight: 800">Fire-side
                                                                                Chat</p>
                                                                            <span> How venture funds help scaling
                                                                                the startups and what attitude
                                                                                should one must carry to raise the
                                                                                fund </span>
                                                                            <h4 class="author-info">Chaired by
                                                                                <span>P.Sec/Sec Finance
                                                                                    Department</span>
                                                                            </h4>
                                                                            <h4 class="author-info">Moderated by -
                                                                                <span>Panelists </span>Rep. from
                                                                                SIDBI, VC firm, Bank, Angel Investor
                                                                            </h4>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="schedule-info">
                                                                    ...
                                                                    <ul style="margin-top: 7rem">
                                                                        <li>
                                                                            <p style="font-weight: 800">Startup
                                                                                Safari - (Powered by D2D Youthstory)
                                                                            </p>
                                                                            <h4 class="author-info">
                                                                                Panel Discussion : "Funding Your
                                                                                Startup Journey"
                                                                                <span>perspectives on funding
                                                                                    strategies, investment criteria,
                                                                                    and the fundraising landscape in
                                                                                    India </span>
                                                                            </h4>
                                                                            <h4 class="author-info">
                                                                                Chaired by – Apurva Chamaria
                                                                                <span>Head of Startups & Venture
                                                                                    Capital, Google India </span>
                                                                            </h4>
                                                                            <h4 class="author-info">
                                                                                Panelist -Gautam Kumar
                                                                                <span>Co-Founder & COO, FarEye
                                                                                </span>
                                                                            </h4>
                                                                            <h4 class="author-info">
                                                                                Tej Kapoor
                                                                                <span>Director & Partner ICICI
                                                                                    Venture </span>
                                                                            </h4>
                                                                            <h4 class="author-info">
                                                                                Panelist:
                                                                                <span>Tarun Bhargava Angel investor
                                                                                    & Co- Founder </span>
                                                            ...
                                                            <div class="lgx-single-schedule">
                                                                ...
                                                                <div class="schedule-info">
                                                                    ...
                                                                    <h3 class="title">Workshop on Product-Market
                                                                        Fit.</h3>
                                                                    <!-- <h4 class="author-info">By <span>Riaz Sagar</span> , Logichunt Inc.</h4> -->
                                                                    <ul>
                                                                        <li>
                                                                            ...
                                                                            <h4 class="author-info">
                                                                                Founders’ Matchmaking - Activities
                                                                            ...
                                                                            <h4 class="author-info">
                                                                                Panel discussion
                                                                                <span>Sustainable Incubation
                                                                                    Business Model for Incubation
                                                                                    centers & Startup Cells -
                                                                                </span>
                                                                                Dr. K. Suresh
                                                                            </h4>
                                                                        </li>
                                                            ...
                                                            <div class="lgx-single-schedule">
                                                                ...
                                                                <div class="schedule-info">
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            <p style="font-weight: 800">Bootcamp
                                                                            </p>
                                                                            <h4 class="author-info">Best practices
                                                                                for Startups in terms of
                                                                                product-market fit, financial
                                                                                regulations and other legal
                                                                                compliance.</h4>
                                                                        </li>
                                                                        <li>
                                                                            <p style="font-weight: 800">Keynote
                                                                                Session</p>
                                                                            <h4 class="author-info">Success stories
                                                                                of successful Startup in Bihar.</h4>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="schedule-info">
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            ...
                                                                            <h4 class="author-info">Panel
                                                                                discussion on export opportunities
                                                                                for Startups in Bihar</h4>
                                                                        </li>
                                                                        <li>
                                                                            <p style="font-weight: 800"></p>
                                                                            <h4 class="author-info"><span>Chaired
                                                                                    by -</span>Secretary, IT
                                                                                Department</h4>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            ...
                                                            <div class="lgx-single-schedule">
                                                                ...
                                                                <div class="schedule-info">
                                                                    ...
                                                                    <h3 class="title">Keynote session by a
                                                                        Celebrity Founder</h3>
                                                                    <!-- <h4 class="author-info">By <span>Riaz Sagar</span> , Logichunt Inc.</h4> -->
                                                                </div>
                                                            </div>
                                                        </a>
                                                    ...
                                                    <div class="panel-title">
                                                        <a role="button" data-toggle="collapse"
                                                            ...
                                                            <div class="lgx-single-schedule">
                                                                ...
                                                                <div class="schedule-info">
                                                                    <h4 class="time">10:35 <span>Am</span> -
                                                                        11.15 <span>Am</span></h4>
                                                                    <h3 class="title">Fireside Chat</h3>
                                                                    <ul>
                                                                        <li>
                                                                            <p style="font-weight: 800">Theme</p>
                                                                            <span> Rebranding Strategies: When and
                                                                                How to Reinvent Your Brand </span>
                                                                            Chaired by
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            <p style="font-weight: 800">Chaired by
                                                                            </p>
                                                                            <span>ACS, Education Department </span>
                                                                        </li>
                                                                    </ul>
                                                            ...
                                                            <div class="lgx-single-schedule">
                                                                ...
                                                                <div class="schedule-info">
                                                                    <h4 class="time">11:15 <span>Am</span> -
                                                                        11:45 <span>Am</span></h4>
                                                                    <h3 class="title">Panel discussions</h3>
                                                                    <ul>
                                                                        <li>
                                                                            Women in Business: The nextgen torch
                                                                            bearers of Entrepreneurship. h
                                                                            <h4 class="author-info">Chaired by
                                                                                <span>Secretary, Industry
                                                                                    Department</span>
                                                                            </h4>
                                                                        </li>
                                                                    </ul>
                                                            ...
                                                            <div class="lgx-single-schedule">
                                                                ...
                                                                <div class="schedule-info">
                                                                    <h3 class="title" style="margin-top: 3.5rem">
                                                                        Panel Discussion</h3>
                                                                    <h4 class="author-info">Incubation Center -
                                                                        Startups Matchmaking (for Startup cells and
                                                                        Incubation centers) <span>Chaired
                                                                            by</span>Secretary DST</h4>
                                                                </div>
                                                                <div class="schedule-info">
                                                                    <!-- <h3 class="title"></h3> -->
                                                                    <h4 class="author-info" style="margin-top: 9rem">
                                                                        Mentors
                                                                        Matchmaking/ Session on Team Building
                                                                        <span>Chaired by</span>Secretary, Labour
                                                                        Department
                                                                    </h4>
                                                                </div>
                                                            </div>
                                                            <div class="lgx-single-schedule">
                                                                ...
                                                                <div class="schedule-info">
                                                                    <h4 class="time">12:45 <span> Pm</span> -
                                                                        1:45 <span>Pm</span></h4>
                                                                    <h3 class="title">Standup Comedy (Theme -
                                                                        Startups)</h3>
                                                                </div>
                                                            </div>
                                                            <div class="lgx-single-schedule">
                                                            ...
                                                            <div class="lgx-single-schedule">
                                                                ...
                                                                <div class="schedule-info">
                                                                    ...
                                                                    <h3 class="title">Keynote by a Celebrity
                                                                        Founder</h3>
                                                                </div>
                                                            </div>
                                                            <div class="lgx-single-schedule">
                                                                ...
                                                                <div class="schedule-info">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li>Awards to Incubation center and Startup
                                                                            Cells</li>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="lgx-heading lgx-heading-white">
                                ...
                                <h3 class="subheading">Welcome to the dedicated to building remarkable Sponsores!
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="lgx-heading">
                                ...
                                <h3 class="subheading">Empowering Startups Through Innovation,
                                    Growth, and Networking</h3>
                            </div>
                        </div>
                        <!--//main COL-->
                    </div>
